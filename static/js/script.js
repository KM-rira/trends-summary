document.addEventListener("DOMContentLoaded", () => {
        ...
        .then((data) => {
            ...
            data.items.forEach((item) => {
                ...
                button.addEventListener("click", () => {
                    ...
                    fetch(`/trends-summary/ai-article-summary?url=${encodeURIComponent(articleUrl)}`)
                        .then((response) => {
                            if (!response.ok) {
    ...
    fetch("/trends-summary/github-trending")
        .then((response) => {
            if (!response.ok) {
                throw new Error(`HTTPエラー: ${response.status}`);
            }
        ...
        .then((data) => {
            ...
            data.forEach((item) => {
                ...
                button.addEventListener("click", () => {
                    ...
                    fetch(
                        `/trends-summary/ai-repository-summary?url=${encodeURIComponent(repositoryUrl)}`,
                    )
                        .then((response) => {
                            if (!response.ok) {
                                throw new Error(`APIエラー: ${response.status}`);
    ...
    fetch("/trends-summary/golang-repository-trending")
        .then((response) => {
            if (!response.ok) {
                throw new Error(`HTTPエラー: ${response.status}`);
            }
    ...
    // TIOBEグラフの取得と表示
    fetch("/trends-summary/tiobe-graph")
        .then((response) => {
            if (!response.ok) {
                throw new Error(`HTTPエラー: ${response.status}`);
            }
    ...
    generateButton.addEventListener("click", function() {
        ...
        fetch(`/trends-summary/ai-trends-summary`, {
            method: "POST",
            headers: {
    ...
    fetch("/trends-summary/golang-weekly-content")
        .then((response) => {
            if (!response.ok) {
    ...
    fetch("/trends-summary/google-cloud-content")
        .then((response) => {
            if (!response.ok) {
                throw new Error(`Network error: ${response.status}`);
            }
    ...
    fetch("/trends-summary/aws-content")
        .then((response) => {
            if (!response.ok) {
                throw new Error(`Network error: ${response.status}`);
            }
    ...
    fetch("/trends-summary/azure-content")
        .then((response) => {
            if (!response.ok) {
                throw new Error(`Network error: ${response.status}`);
            }
